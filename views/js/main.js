...
function updatePositions() {
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    items[i].style.left = items[i].basicLeft + 100 * phase + 'px'; //gut reaction the stylin is bad mkay. CSS
    items[i].style.transform= translate()
  }

  window.performance.mark("mark_end_frame"); // timer API dont worry about it
...
document.addEventListener('DOMContentLoaded', function() { //this fucker is problematic as well. maybe
  var cols = 8;
  var s = 256;
  for (var i = 0; i < 200; i++) {
